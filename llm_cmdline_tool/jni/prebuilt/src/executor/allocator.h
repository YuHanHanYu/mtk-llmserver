...
protected:
    std::shared_ptr<NeuronAdapterLib> getNeuronLib();
...
protected:
    ...
    // Neuron Adapter Lib to create/release NeuronMemory objects. Will be loaded on-demand.
    std::shared_ptr<NeuronAdapterLib> mNpLib;
};
